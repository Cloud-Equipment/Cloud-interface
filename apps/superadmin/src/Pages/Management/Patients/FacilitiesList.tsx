...
const ManageFacilityDropDown = ({
  ...
  const handleMenuAction = () => {
    navigate(`/management/patients/facilities/${id}/patients`);
  };
      ...
      <div>
        ...
        >
          <MenuItem onClick={handleMenuAction}>
            ...
            <ListItemText>View Patients List</ListItemText>
          </MenuItem>
          ...
          <MenuItem onClick={() => console.log('raise ticket')}>
            <ListItemIcon></ListItemIcon>
            <ListItemText>Raise a Ticket</ListItemText>
          </MenuItem>
        </Menu>
      </div>
