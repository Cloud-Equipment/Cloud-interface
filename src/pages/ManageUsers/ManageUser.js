      ...
      <div>
        <div className="ManageUsers">
          ...
          >
            <div className="modal-dialog modal-dialog modal-dialog-centered">
              <div className="modal-content">
                <div className="modal-body EnableModal">
                  <center>
                    <img src={Img1} alt="" />
                    <p>
              ...
              <div className="modal-content">
                <div className="modal-body EnableModal">
                  <center>
                    <img src={Img1} alt="" />
                    <p>
                      Are you sure you want to disable this user? User won’t
                      have access to the platform again.
                    </p>
                    <div className="buttonss">
                      <button
                        type="button"
          ...
          >
            <div className="modal-dialog modal-dialog modal-dialog-centered">
              <div className="modal-content">
                <div className="modal-body InviteModal p-5">
                  ...
                  <div className="mb-3">
                    ...
                    <br />
                    <select
                      className="form-select inputts selectHolder"
                  ...
                  <div className="pt-3">
                    <button
                      type="button"
                      className="btn dark-button  w-100 m-0 f17 Dm"
                      data-bs-toggle="modal"
                      data-bs-target="#edit"
                    >
                      Invite Team Member
          ...
          <div className="ManageUser">
            ...
            <div className="AllManageBtn pt-5 pb-5">
              <div className="manageButtons">
                <button
                  className="btn secondaryButtonBackground"
                  type="button"
                  data-bs-toggle="modal"
                ...
                <Link to="/manage-role">
                  <button className="secondaryButtonBorder">
                    Manage Roles
                  </button>
                </Link>
                ...
                <button
                  type="button"
                  className="btn secondaryButtonNoBg"
                  data-bs-toggle="modal"
                ...
                <div className="USERSTable">
                  ...
                  <div className="">
                    <table className="w-100">
                      ...
                      <tbody>
                        <tr className="">
                          <th scope="">01-12-2023 . 10:23.27</th>
