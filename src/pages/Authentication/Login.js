                                ...
                                <div className=" LoginForm">
                                    <div className="header">
                                        ...
                                        <form action="">
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput12" class="form-label">Password</label>
                                                <input type="password" class="" id="exampleFormControlInput12" placeholder="*****" />
                                                <span>Forgot Password ?</span>
                                            </div>
                                            <div className="margin30"></div>
                                            <center>
                                                <button className='mb-3 dark-button w-100 f20' type="submit">Log In</button>
